...
export type Unnamed_12_Mutation = (
  ...
  & { updateBranch?: Maybe<(
    { __typename?: 'Branch' }
    & Pick<Branch, 'id' | 'branchName' | 'branchCode' | 'abbreviation' | 'address1' | 'address2' | 'city' | 'state' | 'zip' | 'zipExt' | 'phone' | 'phoneExt' | 'fax' | 'contactName' | 'contactTitle' | 'contactPhone' | 'contactPhoneExt' | 'contactEmail' | 'stage'>
    & { company?: Maybe<(
      { __typename?: 'Company' }
      & Pick<Company, 'id'>
      & { companyUsers: Array<(
